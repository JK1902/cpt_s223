...
/********************* Start Microassignment zone ********************/
	 ...
	 */
	void percolateDown(long unsigned int hole) {
	...
	{
    	_items.push_back(item); // Add the new item to the end of the heap
    long unsigned int hole = size(); // Index of the newly added item
